...
export const LEVEL_BIOMES_EARTH: LevelBiomes = [
  {
    // WATER - limited presence
    params: { lowerBound: 0.0, upperBound: 0.1 },
    data: {
  ...
  {
    // SAND - larger presence
    params: { lowerBound: 0.1, upperBound: 0.4 },
    data: {
      type: BiomeType.SAND,
      tileIndex: 6,
      z: 0,
      collide: false,
      solid: true,
      spawn: [SpawnTarget.CRYSTAL, SpawnTarget.SCENERY]
    }
  },
  {
    // GRASS - larger presence
    params: { lowerBound: 0.4, upperBound: 1.0 },
    data: {
