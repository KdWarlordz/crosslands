...
import type { Chains, Planets } from './src/providers/interfaces.js'
import { IConfig } from './src/models/configModel.js'
...
app.get(
  '/api/chains/:chain/:planet/:id',
  async (req: Request, res: Response) => {
    const { chain, planet, id } = req.params as {
      chain: Chains
      planet: Planets
      id: string
    }
...
app.post('/api/addworld', async (req: Request, res: Response) => {
...
app.post('/api/config', async (req: Request, res: Response) => {
  const configData: IConfig = req.body
  try {
